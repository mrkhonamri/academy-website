...
import { Image, Megaphone, BookOpen, BarChart3, Settings, MessageSquare, Users, Sliders, Star, Mail, KeyRound, GraduationCap } from "lucide-react";
...
const sections = [
  ...
  { title: "رمز عبور", href: "/admin/password", icon: <KeyRound className="h-8 w-8" />, color: "from-orange-500 to-amber-500", desc: "تغییر رمز پنل" },
  { title: "برنامه‌ها", href: "/admin/programs", icon: <GraduationCap className="h-8 w-8" />, color: "from-indigo-500 to-blue-600", desc: "گروه‌های سنی و سطح‌ها" },
];
